...
//	method for testing purpose will be deleted when database will be implemented
		Game game1 = new Game("Call of Duty, Black Ops", 
				...
				5, "5030917085765", 35.00, 1.00, "resources/images/game0.jpg",
				"resources/images/game0l.jpg", 0.00, Genre.Shooter, 
				Platform.XboxOne);
		Game game2 = new Game("Minecraft", 
				...
				"resources/images/game0l.jpg", 30.00, Genre.Simulator,
				Platform.XboxOne);
		Game game3 = new Game("Tomb Rider", 
				...
				"resources/images/game0l.jpg", 15.00, Genre.Action, 
				Platform.XboxOne);
		Game game4 = new Game("Fallout 4",
				...
				"resources/images/game0l.jpg", 20.00, Genre.Action,
				Platform.XboxOne);
